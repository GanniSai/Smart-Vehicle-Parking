...
if (isset($_POST['pay_reservations'])) {
    ...
    if (!$error) {
        ...
        if (mysqli_num_rows($res) > 0) {
            ...
            if ($stmt) {
                $success = 'Client Account Parking Reservation Paid' && header('refresh:1; url=add.php');
            } else {
                                ...
                                while ($reserv = $res->fetch_object()) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- Update Modal -->
                                            <div id="pay-<?php echo $reserv->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                            ...
                                                            <form method="post" enctype="multipart/form-data">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        ...
                                                                        <?php
                                                                        // Assume $reserv is your reservation object with 'parking_duration' property
                                                                        if (isset($reserv) && property_exists($reserv, 'parking_duration')) {
                                                                            // Parking duration is available in the reservation object
                                                                            $parking_duration = $reserv->parking_duration;

                                                                            // Your existing code here

                                                                            // Calculate parking fee on the server side
                                                                            $parking_fee = $reserv->amt * $parking_duration;

                                                                            // Your existing HTML form with the updated 'amt' input
                                                                        ?>
                                                                            <div class="form-group col-md-6">
                                                                                <label for="">Parking Fee</label>
                                                                                <input type="text" required name="amt" value="<?php echo $parking_fee; ?>" class="form-control">
                                                                            </div>
                                                                        <?php
                                                                        } else {
                                                                            // Handle the case where 'parking_duration' is not available
                                                                            echo "Error: Parking duration not available.";
                                                                        }
                                                                        ?>
